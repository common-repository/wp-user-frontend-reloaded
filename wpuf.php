...
/*
Plugin Name: WP User Frontend - Reloaded
Plugin URI: http://wordpress.org/extend/plugins/wp-user-frontend-reloaded/
Description: Based on WP User Frontend by Tarek Hasan. The original plugin does not support private posts. This version adds private posts capabilities.
Author: Ahmed Ghazi
Version: 1.0.5
Author URI: http://www.aitsys.com
*/
...
class WPUF_Main {
    ...
    function enqueue_scripts() {
        $path = plugins_url( 'wp-user-frontend-reloaded' );
