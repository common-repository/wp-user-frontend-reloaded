                            ...
                            <li>
                                ...
                                <div class="category-wrap" style="float:left;">
									...
									$default_taxonomy = $default_taxonomy['default_taxonomy'];
                                        if ( $cat_type == 'normal' ) {
                                            wp_dropdown_categories( 'show_option_none=' . __( '-- Select --', 'wpuf' ) . '&taxonomy='.$default_taxonomy.'&hierarchical=1&hide_empty=0&orderby=name&name=category[]&id=cat&show_count=0&title_li=&use_desc_for_title=1&class=cat requiredField&exclude=' . $exclude );
                                        } else if ( $cat_type == 'ajax' ) {
                                            wp_dropdown_categories( 'show_option_none=' . __( '-- Select --', 'wpuf' ) . '&taxonomy='.$default_taxonomy.'&hierarchical=1&hide_empty=0&orderby=name&name=category[]&id=cat-ajax&show_count=0&title_li=&use_desc_for_title=1&class=cat requiredField&depth=1&exclude=' . $exclude );
                                        } else {
                                            wpuf_category_checklist(0, false, $default_taxonomy, $exclude);
                                        }
                                        ?>
                                    </div>
                                </div>
